...
Do not rely on print/export from the ChatGPT HTML preview, so the Report tab has **no print or export buttons**. It renders its content on-screen only.
...
- [ ] No print/export buttons in the Report tab (ChatGPT HTML preview)
