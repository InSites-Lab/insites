...
| Visual documentation | ✓/— | Images uploaded / embedded / none |
  ...
  - If no locality, region, address, or other place anchor is found, note this in the Gaps List and ask the user to add location information. Exact coordinates are not required, but are recommended when available.
...
- **"kg"** — knowledge graph of the assessment entities and relationships
